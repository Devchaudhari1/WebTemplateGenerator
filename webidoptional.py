...
with open(viewshtml,'w') as vh:
    ...
    vh.write(f"<link href =\"./output.css\" rel=\"stylesheet\"/>")
    vh.write(f"<link href= \"./css/styles.css\" rel= \"stylesheet\">\n")
    vh.write(f"</head>\n")
    vh.write(f"<body>\n")
    #Frontend code
    # Html Part
    ...
    vh.write(f"      <div class=\"heading\">\n")
    vh.write(f"                <strong>{name}</strong>\n")
    vh.write(f"        </div>\n")
    vh.write(f"        <div class=\"subheading\">\n")
    vh.write(f"                <button>Open Menu</button>\n")
    vh.write(f"        </div>\n")
    vh.write(f"<div class=\"contents\">\n")
    vh.write(f"                <div class=\"navbar hidden\">\n")
    vh.write(f"                        <ul>\n")
    vh.write(f"                                <a href=\"./activitiesPage\"><li>activities</li></a>\n")
    vh.write(f"                                <a href=\"./activity_bookingsPage\"><li>activity_bookings</li></a>\n")
    vh.write(f"                                <a href=\"./busPage\"><li>bus</li></a>\n")
    vh.write(f"                                <a href=\"./busbookingsPage\"><li>busbookings</li></a>\n")
    vh.write(f"                                <a href=\"./business_partnersPage\"><li>business_partners</li></a>\n")
    vh.write(f"                                <a href=\"./cabbookingsPage\"><li>cabbookings</li></a>\n")
    vh.write(f"                                <a href=\"./cabdriversPage\"><li>cabdrivers</li></a>\n")
    vh.write(f"                                <a href=\"./cabsPage\"><li>cabs</li></a>\n")
    vh.write(f"                                <a href=\"./currenciesPage\"><li>currencies</li></a>\n")
    vh.write(f"                                <a href=\"./currency_conversion_ratesPage\"><li>currency_conversion_rates</li></a>\n")
    vh.write(f"                                <a href=\"./email_notificationsPage\"><li>email_notifications</li></a>\n")
    vh.write(f"                                <a href=\"./email_templatesPage\"><li>email_templates</li></a>\n")
    vh.write(f"                                <a href=\"./faqsPage\"><li>faqs</li></a>\n")
    vh.write(f"                                <a href=\"./flightbookingsPage\"><li>flightbookings</li></a>\n")
    vh.write(f"                                <a href=\"./flightsPage\"><li>flights</li></a>\n")
    vh.write(f"                                <a href=\"./hotelbookingsPage\"><li>hotelbookings</li></a>\n")
    vh.write(f"                                <a href=\"./hotelsPage\"><li>hotels</li></a>\n")
    vh.write(f"                                <a href=\"./itinerariesPage\"><li>itineraries</li></a>\n")
    vh.write(f"                                <a href=\"./itinerary_placesPage\"><li>itinerary_places</li></a>\n")
    vh.write(f"                                <a href=\"./languagesPage\"><li>languages</li></a>\n")
    vh.write(f"                                <a href=\"./logsPage\"><li>logs</li></a>\n")
    vh.write(f"                                <a href=\"./notificationsPage\"><li>notifications</li></a>\n")
    vh.write(f"                                <a href=\"./payment_gateway_feesPage\"><li>payment_gateway_fees</li></a>\n")
    vh.write(f"                                <a href=\"./payment_gateway_transactionsPage\"><li>payment_gateway_transactions</li></a>\n")
    vh.write(f"                                <a href=\"./paymentsPage\"><li>payments</li></a>\n")
    vh.write(f"                                <a href=\"./placesPage\"><li>places</li></a>\n")
    vh.write(f"                                <a href=\"./promotionsPage\"><li>promotions</li></a>\n")
    vh.write(f"                                <a href=\"./refundsPage\"><li>refunds</li></a>\n")
    vh.write(f"                                <a href=\"./restaurantsPage\"><li>restaurants</li></a>\n")
    vh.write(f"                                <a href=\"./reviewsPage\"><li>reviews</li></a>\n")
    vh.write(f"                                <a href=\"./social_media_accountsPage\"><li>social_media_accounts</li></a>\n")
    vh.write(f"                                <a href=\"./trainbookingsPage\"><li>trainbookings</li></a>\n")
    vh.write(f"                                <a href=\"./trainsPage\"><li>trains</li></a>\n")
    vh.write(f"                                <a href=\"./travel_curatorsPage\"><li>travel_curators</li></a>\n")
    vh.write(f"                                <a href=\"./user_preferencesPage\"><li>user_preferences</li></a>\n")
    vh.write(f"                                <a href=\"./usersPage\"><li>users</li></a>\n")
    vh.write(f"                                <a href=\"./weather_infoPage\"><li>weather_info </li></a>\n")
    vh.write(f"                        </ul>\n")
    vh.write(f"                </div>\n")
    #form part
    ...
    vh.write(f"  <div class=\"formentry\">\n")
    while i< c:
        vh.write("\n")
        t=type[i]
        if type[i] == 'int' :
    ...
    vh.write(f"        <div class=\"search\">\n")
    vh.write(f"        <input type=\"text\" placeholder=\"Search\" class=\"searchBar\" id= \"searchBar\"/>     \n")
    vh.write(f"\n\n<ul id=\"searchList\"></ul>")
    ...
    i=0
    vh.write(f"        <div class=\"footer\"></div>\n")
    vh.write(f"        <script src=\"{name}.js\"></script>\n")
    vh.write(f"        <script>\n")
    vh.write(f"                const openBtn = document.querySelector('.subheading button');\n")
    vh.write(f"                const navbar = document.querySelector('.navbar');\n")
    vh.write(f"                openBtn.addEventListener('click',()=>\n")
    vh.write(f"        {{\n")
    vh.write(f"                console.log(\"openbtn clicked\")\n")
    vh.write(f"                navbar.classList.toggle('hidden');\n")
    vh.write(f"        }});\n")
